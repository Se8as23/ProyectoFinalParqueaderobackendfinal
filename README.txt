...
a persistence unit "ProyectoFinalParqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoFinalParqueadero/pom.xml":
...
artifact ("ProyectoFinalParqueadero.war") is already built. You can build
